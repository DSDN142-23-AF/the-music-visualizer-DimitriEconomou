...
let leftheartliney =map(counter,4,47.5,400,225)
if(counter>4&&counter<47.5){
  ...
  stroke(37, 87, 69)
  strokeWeight(10)
  line(440,400,310,225)
  }
////////////////////////////////////////////////////////////left arc heart
  let lefthpoint1x =map(counter,47.5,59.375,310,320)
  let lefthpoint1y =map(counter,47.5,59.375,225,150)
  ...
  if(counter>0&&counter<47.5){}
      ...
      noFill()
      beginShape();
      if (counter>47.5) curveVertex(310, 225); 
      if (counter>47.5) curveVertex(310, 225); 
...
let righthpoint4y =map(counter,130.625,142.5,150,225)
...
if(counter>0&&counter<95){}
  ...
  if (counter>=130.625&&counter<142.5) curveVertex(righthpoint4x,righthpoint4y);
  if (counter>=142.5) curveVertex(570, 225);
  if (counter>=142.5) curveVertex(570, 225) 
  endShape() 
}
//////////////////////////////////////////////////////////////right line heart
  let rightheartlinex =map(counter,142.5,190,570,440)
  let rightheartliney =map(counter,142.5,190,225,400)
  if(counter>=142.5&&counter<190){
    stroke(37, 87, 69)
    strokeWeight(10)
    line(570,225,rightheartlinex,rightheartliney)
    }
...
strokeWeight(2)
  ...
  textSize(10);
   ...
   textAlign(CENTER);
   textSize(vocal/2.65);
   text(words, width/1.825, height-220);
//timer   
// fill(255, 255, 0); 
// let seconds = counter
